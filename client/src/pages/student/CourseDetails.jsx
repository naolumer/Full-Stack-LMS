  ...
  return courseData ?  (
    ...
    <div className="flex md:flex-row flex-col gap-10 relative items-start justify-between md:px-36 px-8 md:pt-30 pt-20 text-left">
      ...
      <div className='max-w-xl z-10 text-gray-500'>
        ...
        <p className='mt-6' dangerouslySetInnerHTML={{ __html: courseData.courseDescription.slice(0, 200) }}></p>
        ...
        {/* Course Provider */}
        <p className='text-sm'>Course by <span className='text-blue-600 underline'>GreekStack</span></p>
